...
const TypeSelect: React.FC = () => {
    const typeOptions = ["Conference", "Discussion/Recitation", "Independent Study", "Internship", "Laboratory", "Laboratory-Discussion", "Lecture", "Lecture-Discussion", "Online", "Online Lab", "Online Lecture", "Packaged Section", "Practice", "Quiz", "Research", "Seminar", "Studio", "Study Abroad"]
        ...
        <div className="type-dropdown-wrapper">
            <div className="type-buttons-container">
                <div className="type-dropdown">
                    <button onClick={() => setDropdownOpen(!dropdownOpen)} className="type-dropdown-button">
                        {types.length > 0 ? `${types.length} Types Selected` : "Select Type"}
                    </button>
                    {dropdownOpen && (
