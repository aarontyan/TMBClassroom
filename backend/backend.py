...
def get_current_classes():
    ...
    # current_time =  dt.time(current_info.hour, current_info(tz=time_zone).minute, tzinfo = time_zone)
    ...
    for entry in entrees:
        ...
        if start_time_str and end_time_str:
            ...
            if start_time < current_time and end_time > current_time and isCurrentDay(days):
                del entry['_id']
